...
import com.openwebinars.secondhandmarket.repositorio.ProductoRepository;
...
public class ProductoServicio {
	...
	public void borrar(Producto p) {
		if(!p.getImagen().isEmpty()) // si no esta  vacio
			storageService.delete(p.getImagen()); // borramos la imagen del producto
