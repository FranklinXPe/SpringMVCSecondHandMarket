...
public class FileSystemStorageService implements StorageService {
	...
	public String store(MultipartFile file) {
        ...
        // Almacenamos el nombre del fichero, junto con la fecha del sistema. De esta manera nunca tendremos una colision cuando dos personas suban un fiechero
        String storedFilename = System.currentTimeMillis() + "_" + justFilename + "." + extension;
        try {
            if (file.isEmpty()) { // Si el fichero esta vacio
                throw new StorageException("Failed to store empty file " + filename);
            }
            if (filename.contains("..")) { //si alguien trato de subir algo que no debe
