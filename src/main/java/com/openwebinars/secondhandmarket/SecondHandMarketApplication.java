		...
		return args -> {
			...
			List<Producto> listado = Arrays.asList(new Producto("Bicicleta de montaña", 100.0f,
					...
					new Producto("Raqueta de tenis", 10.5f,
							...
							usuario),
					new Producto("Xbox One X", 425.0f, "https://images.vibbo.com/635x476/860/86038583196.jpg",
							usuario2),
					new Producto("Trípode flexible", 10.0f, "https://images.vibbo.com/635x476/860/86074256163.jpg",
							usuario2),
